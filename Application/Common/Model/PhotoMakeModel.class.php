 ...
 * 影楼分类表
 */
class PhotoMakeModel extends Model{
	protected $tableName="photo_make";
   ...
   public function make($data){
   		$info = M('photo_make')->where(array('p_p_id'=>$data['p_p_id'],'is_date'=>date('Y-m-d'),'make_phone'=>$data['make_phone']))->find();
   		if($info){
