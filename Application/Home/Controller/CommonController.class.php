...
//		dump($_SESSION);
	 ...
	 public function header_two(){
	 	$header_two['member'] = $this->member->getData();
	 ...
	 public function bottom(){
	 	$bottom['friend'] = M('friend')->select();
	 	$re = M('site_config')->select();
	 	$bottom['home'] = explode('\\',$re[12]['attr_value']);
	 	$bottom['code'] = array('0'=>$re[7]['attr_value'],'1'=>$re[8]['attr_value']);
	 	$bottom['copyright'] = array('0'=>$re[9]['attr_value'],'1'=>$re[10]['attr_value'],'2'=>$re[11]['attr_value']);
