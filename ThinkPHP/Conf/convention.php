...
return  array(
    ...
    //RBAC配置
    'RBAC_SUPERADMIN' => 'boom', //超级管理员名称
    'ADMIN_AUTH_KEY' => 'super', //超级管理员识别
    'USER_AUTH_ON' => true, //是否开启验证
    'USER_AUTH_TYPE' => 2, //验证类型 （1 登录验证 2 实时验证）
    'USER_AUTH_KEY' => 'admin_id', //用户谁识别号
    'NOT_AUTH_MODULE' => '', //无需验证的模块
    'NOT_AUTH_ACTION' => array('index','welcome'), //无需验证的动作方法
    'RBAC_ROLE_TABLE' => 'role', //角色表名称
    'RBAC_USER_TABLE' => 'role_admin', //角色和用户的中间表名称
